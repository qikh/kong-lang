...
public class NodeValue implements Comparable<NodeValue> {
  ...
  public static final NodeValue NULL = new NodeValue();
  public static final NodeValue VOID = new NodeValue();
  ...
  public List<NodeValue> asList() {
    return (List<NodeValue>) value;
  }
  ...
  //@Override
  public int compareTo(NodeValue that) {
